...
{% block footer %}
  ...
  <div id="footer" class="footer">
    <div class="content">
      <div class="tools">
        {% block footer_links %}
          <a href="http://compupz.com/soporte/" target="_blank" class="icon"><i class="icon-question-sign"></i>Soporte</a>
      ...
      <div class="copyright">
        {% block copyright %}
          Derechos reservados &copy; 2015 Avanzado Juntos<br>Desarrolado por <a href="http://compupz.com" target="_blank">CompuPZ</a>
        {% endblock %}
      </div>
