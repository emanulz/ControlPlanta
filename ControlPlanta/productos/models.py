...
class Producto(models.Model):
    ...
    cost= models.FloatField(default=0, verbose_name='Precio ₡')
    cost2 = models.FloatField(default=0, null=True, verbose_name='Costo ₡')
    last_cost_change = models.DateField(null=True, verbose_name='Último cambio en costo')
