...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Producto
        fields =('id','product_code','bar_code','description','inventory','minimum','cost','autoprice','utility1','utility2','utility3','price1','price2','price3','ventaneg','fractioned','taxes', 'taxes_amount', 'category')
