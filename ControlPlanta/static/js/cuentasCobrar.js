...
function llenartablafacturas (factura){
    ...
    '</td><td><button style="width: 75px" type="button" class=" btn btn-success form-control selectrownotacred " id="btnelegir"><span class="glyphicon glyphicon-chevron-right"></span></button></td>' +
