...
SECRET_KEY = 'wumv1woo&ig1zdx92fwx*$_p9q9_2f@vykea&z7cyl2j21mge%'
...
if socket.gethostname().startswith('Mac'):
    ...
    WSGI_APPLICATION = 'ControlPlanta.wsgiWindows.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = "/Volumes/DATOS/Avanzando_Juntos/ControlPlanta/ControlPlanta/static/"
