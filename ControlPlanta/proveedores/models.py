...
class Proveedor(models.Model):
    ...
    identification = models.PositiveIntegerField(unique=False, null=True, verbose_name='Número de cédula')
    provcode = models.PositiveIntegerField(null=True, verbose_name='Código de proveedor')
