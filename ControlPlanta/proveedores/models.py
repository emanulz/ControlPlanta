...
class Proveedor(models.Model):
    ...
    identification = models.PositiveIntegerField(unique=True, blank=True, verbose_name='Número de cédula')
    provcode = models.PositiveIntegerField(unique=True, verbose_name='Código de proveedor')
