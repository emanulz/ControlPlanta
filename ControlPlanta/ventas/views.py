...
class VentaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Venta
        fields =('id','client','nombrecliente','cashier','date','time','totolkilogramos','cantidadarticulos','subtotal','iv','descopor','desctocol','total','detalleproductos','datosdelpago','saldo')
...
class VentaViewSet(viewsets.ModelViewSet):
    ...
    lookup_field = 'id'
    filter_fields=('id','client','nombrecliente','cashier','date','time','totolkilogramos','cantidadarticulos','subtotal','iv','descopor','desctocol','total','detalleproductos','datosdelpago','saldo')
